...
FAMISTUDIO_EXP_NONE = 0
    ...
    .if (FAMISTUDIO_EXP_VRC7 + FAMISTUDIO_EXP_EPSM + FAMISTUDIO_EXP_N163 + FAMISTUDIO_EXP_FDS + FAMISTUDIO_EXP_S5B) != 0
...
FAMISTUDIO_EXP_NOTE_START = 7
    ...
    .if (FAMISTUDIO_USE_DELTA_COUNTER != 0) & (FAMISTUDIO_CFG_DPCM_SUPPORT = 0)
    .error "Delta counter only makes sense if DPCM samples are enabled."
    .endif

    .if (FAMISTUDIO_USE_DPCM_BANKSWITCHING != 0) & (FAMISTUDIO_CFG_DPCM_SUPPORT = 0)
...
famistudio_dmc_delta_counter:     .rs 1
    .endif
    .if FAMISTUDIO_EXP_VRC6
...
famistudio_chn_epsm_vol_op3:      .rs 6
...
; FDS, N163 and VRC7 have very different instrument layout and are 16-bytes, so we keep them seperate.
    .if (FAMISTUDIO_EXP_FDS != 0) | (FAMISTUDIO_EXP_N163 != 0) | (FAMISTUDIO_EXP_VRC7 != 0) | (FAMISTUDIO_EXP_EPSM != 0) | (FAMISTUDIO_EXP_S5B != 0)
...
.valid_song:
    ...
    .if (FAMISTUDIO_EXP_FDS != 0) | (FAMISTUDIO_EXP_VRC7 != 0) | (FAMISTUDIO_EXP_EPSM != 0) | (FAMISTUDIO_EXP_N163 != 0) | (FAMISTUDIO_EXP_S5B != 0)
...
famistudio_update_row:
    ...
    .if (FAMISTUDIO_EXP_VRC6 != 0) | (FAMISTUDIO_EXP_MMC5 != 0) 
    bne .base_instrument
    .else
    bcc .base_instrument
    .endif
    .if (FAMISTUDIO_EXP_FDS != 0) | (FAMISTUDIO_EXP_VRC7 != 0) | (FAMISTUDIO_EXP_N163 != 0) | (FAMISTUDIO_EXP_EPSM != 0) | (FAMISTUDIO_EXP_S5B != 0)
    beq .dpcm
    .if FAMISTUDIO_EXP_FDS
    .fds_instrument:
...
.set_final_update_flags:
    ...
    .if (FAMISTUDIO_EXP_VRC7 != 0) | (FAMISTUDIO_EXP_EPSM != 0)
.set_vrc7_triggers:
    cmp #0
    beq .done
    .if FAMISTUDIO_EXP_VRC7
...
.note_table_done:
    ...
    sta famistudio_slide_pitch_hi,x
    .if (FAMISTUDIO_EXP_N163 != 0) | (FAMISTUDIO_EXP_VRC7 != 0) | (FAMISTUDIO_EXP_EPSM != 0)
