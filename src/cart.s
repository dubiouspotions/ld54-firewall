...
DRAW_FIRE:
	...
	; 	STA mem_fire_sprites ; Y Position
	; 	STA mem_fire_sprites + X, 1 ; Tile (animated)
	; 	STX %00000010
	; 	STX mem_fire_sprites + X, 2 ; Settings
	; 	STA mem_fire_sprites + X, 3 ; X (same for all)
	; 	; Initial value should be mem_fire_sprite, then add 1 at the time 
	; 	; until 16 * 4 (64) is reached
...
fire_sprite_data:
	.byte $88, $40, %00000010, $00
	; .byte $88, $40, %01000010, $FC
